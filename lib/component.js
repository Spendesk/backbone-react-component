...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['react', 'react-dom', 'prop-types', 'backbone', 'underscore'], factory);
  } else if (typeof module !== 'undefined' && module.exports) {
    module.exports = factory(require('react'), require('react-dom'), require('prop-types'), require('backbone'), require('underscore'));
  } else {
    factory(root.React, root.ReactDOM, root.PropTypes, root.Backbone, root._);
  }
}(this, function (React, ReactDOM, PropTypes, Backbone, _) {
  'use strict';
  if (!Backbone.React) {
    Backbone.React = {};
  }
